...
`,L={title:"ui/components/atoms/input-text",component:x,argTypes:{isValid:{control:"boolean"}}},i={args:{label:"Email",type:"email",name:"email",placeholder:"",isValid:!0}},o={args:{label:"Contraseña",type:"password",name:"password",placeholder:"",isValid:!0,eyeIcon:P}},l={args:{label:"Nombre",type:"text",name:"name",placeholder:"",isValid:!0}};var m,u,_;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    label: 'Email',
    type: 'email',
    name: 'email',
...
}`,...(w=(v=l.parameters)==null?void 0:v.docs)==null?void 0:w.source}}};const H=["EmptyEmailField","EmptyPasswordField","EmptyNameField"];export{i as EmptyEmailField,l as EmptyNameField,o as EmptyPasswordField,H as __namedExportsOrder,L as default};
