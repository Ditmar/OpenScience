import{j as i}from"./jsx-runtime-BTJTZTIL.js";import{I as C}from"./icons-CVVufTdu.js";import"./index-ChsGqxH_.js";import"./index-CQJd15Kt.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";const h="_secondary_11835_17",t={"button-burger":"_button-burger_11835_1",secondary:h,"button-icon":"_button-icon_11835_49"};function u({icon:r,color:o,onClick:m}){const g=o?t[o]:"";return i.jsx("button",{className:`${t["button-burger"]} ${g}`,"aria-label":"Menu",onClick:m,children:r&&i.jsx(C,{"data-testid":"button-icon",src:r,className:t["button-icon"]})})}u.__docgenInfo={description:"",methods:[],displayName:"BurgerButton",props:{variant:{required:!1,tsType:{name:"union",raw:"'main' | 'secondary'",elements:[{name:"literal",value:"'main'"},{name:"literal",value:"'secondary'"}]},description:""},icon:{required:!1,tsType:{name:"string"},description:""},color:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"}]},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const f=`<svg width="62" height="62" viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,k={title:"ui/components/atoms/burger-bsutton",component:u,argTypes:{onClick:{action:"clicked"}}},n={args:{icon:f,variant:"main",color:"primary",onClick:()=>{console.log("Button clicked")}}},e={args:{variant:"secondary",icon:w,onClick:()=>{console.log("Button clicked")}}};var a,s,c;n.parameters={...n.parameters,docs:{...(a=n.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
    icon: IconBurger,
    variant: 'main',
    color: 'primary',
...
}`,...(p=(d=e.parameters)==null?void 0:d.docs)==null?void 0:p.source}}};const x=["Primary","Secondary"];export{n as Primary,e as Secondary,x as __namedExportsOrder,k as default};
