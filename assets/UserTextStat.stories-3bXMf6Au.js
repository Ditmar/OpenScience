import{j as e}from"./jsx-runtime-BlDnFLNC.js";import"./index-Cu9bd8lq.js";import ae from"./Info-Tooltip-C7inAbXW.js";import te from"./error-BgHEfqKV.js";import re from"./circle-quarters-B2Y1lMV2.js";import O from"./check-BE8zjXxp.js";const se="_white_1rh90_12",ne="_lavender_1rh90_15",ie="_gray_1rh90_18",oe="_checkbox_1rh90_21",ce="_avatar_1rh90_26",le="_content_1rh90_32",ue="_user_1rh90_1",me="_text_1rh90_41",de="_timestamp_1rh90_48",a={"user-text-stat":"_user-text-stat_1rh90_1",white:se,lavender:ne,gray:ie,checkbox:oe,avatar:ce,content:le,user:ue,text:me,timestamp:de,"icon-wrapper":"_icon-wrapper_1rh90_53"},pe={default:a.default,success:a.success,warning:a.warning,error:a.error},he={small:a.small,medium:a.medium,large:a.large};function Q({title:B,mainValue:H,subValue:m,description:p,variant:K="default",icon:h,size:P="medium",onClick:g,className:Y,avatarUrl:d,showCheckbox:Z,styleVariant:$="white"}){const ee=a[$]??"",v=[a["user-text-stat"],ee,pe[K],he[P],Y??""].join(" "),f=e.jsxs(e.Fragment,{children:[Z&&e.jsx("input",{type:"checkbox",className:a.checkbox}),d&&e.jsx("img",{src:d,alt:"Avatar",className:a.avatar}),e.jsxs("div",{className:a.content,children:[e.jsxs("div",{className:a.user,children:[h&&!d&&e.jsx("span",{className:a["icon-wrapper"],children:h}),e.jsx("span",{children:B})]}),e.jsx("div",{className:a.text,children:H}),m!=null&&e.jsx("div",{className:a.timestamp,children:m}),p&&e.jsx("div",{className:a.text,children:p})]})]});return g?e.jsx("button",{type:"button",onClick:g,className:v,style:{textAlign:"left",background:"none",border:"none",padding:0},children:f}):e.jsx("div",{className:v,children:f})}Q.__docgenInfo={description:"",methods:[],displayName:"UserTextStat",props:{title:{required:!0,tsType:{name:"string"},description:""},mainValue:{required:!0,tsType:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}]},description:""},subValue:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:""},description:{required:!1,tsType:{name:"string"},description:""},variant:{required:!1,tsType:{name:"union",raw:"'default' | 'success' | 'warning' | 'error'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'success'"},{name:"literal",value:"'warning'"},{name:"literal",value:"'error'"}]},description:"",defaultValue:{value:"'default'",computed:!1}},size:{required:!1,tsType:{name:"union",raw:"'small' | 'medium' | 'large'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"},{name:"literal",value:"'large'"}]},description:"",defaultValue:{value:"'medium'",computed:!1}},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:""},icon:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},avatarUrl:{required:!1,tsType:{name:"string"},description:""},showCheckbox:{required:!1,tsType:{name:"boolean"},description:""},styleVariant:{required:!1,tsType:{name:"union",raw:"'white' | 'lavender' | 'gray'",elements:[{name:"literal",value:"'white'"},{name:"literal",value:"'lavender'"},{name:"literal",value:"'gray'"}]},description:"",defaultValue:{value:"'white'",computed:!1}}}};const be={title:"ui/components/atoms/user-text-stat",component:Q},t={args:{title:"Christeen Lee",mainValue:`
...
}`,...(V=(x=t.parameters)==null?void 0:x.docs)==null?void 0:V.source}}};var b,w,_;r.parameters={...r.parameters,docs:{...(b=r.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    title: 'Christeen Lee',
    mainValue: \`
    UI is the canvas, UX the brushstroke; together, they craft an immersive journey 
...
}`,...(_=(w=r.parameters)==null?void 0:w.docs)==null?void 0:_.source}}};var C,j,U;s.parameters={...s.parameters,docs:{...(C=s.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    title: 'Christeen Lee',
    mainValue: \`
    UI is the canvas, UX the brushstroke; together, they craft an immersive journey 
...
}`,...(U=(j=s.parameters)==null?void 0:j.docs)==null?void 0:U.source}}};var k,I,S;n.parameters={...n.parameters,docs:{...(k=n.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    title: 'Jane Doe',
...
}`,...(F=(M=u.parameters)==null?void 0:M.docs)==null?void 0:F.source}}};const we=["WhiteCard","LavenderCard","GrayCard","MinimalUserCard","Default","Success","Warning","Error","WithDescription"];export{i as Default,l as Error,s as GrayCard,r as LavenderCard,n as MinimalUserCard,o as Success,c as Warning,t as WhiteCard,u as WithDescription,we as __namedExportsOrder,be as default};
