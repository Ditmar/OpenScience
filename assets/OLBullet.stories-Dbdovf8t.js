import{j as s}from"./jsx-runtime-DRTy3Uxn.js";import"./index-BBkUAzwr.js";const r={"ol-bullet":"_ol-bullet_1xe8f_106","ol-bullet--active":"_ol-bullet--active_1xe8f_111","ol-bullet--circle":"_ol-bullet--circle_1xe8f_115","ol-bullet--rounded":"_ol-bullet--rounded_1xe8f_118","ol-bullet--square":"_ol-bullet--square_1xe8f_121","ol-bullet--sm":"_ol-bullet--sm_1xe8f_124","ol-bullet--md":"_ol-bullet--md_1xe8f_128","ol-bullet--lg":"_ol-bullet--lg_1xe8f_132"};function _(e){const{shape:a="square",size:Re="md",active:Me=!1}=e,je=`
    ${r["ol-bullet"]}
    ${r[`ol-bullet--${a}`]}
    ${r[`ol-bullet--${Re}`]}
    ${Me?r["ol-bullet--active"]:""}
  `.trim();return s.jsx("span",{className:je,role:"presentation"})}_.__docgenInfo={description:"",methods:[],displayName:"OLBullet",props:{shape:{required:!1,tsType:{name:"union",raw:"'square' | 'rounded' | 'circle'",elements:[{name:"literal",value:"'square'"},{name:"literal",value:"'rounded'"},{name:"literal",value:"'circle'"}]},description:""},size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:""},active:{required:!1,tsType:{name:"boolean"},description:""}}};const Oe={title:"ui/components/atoms/ol-bullet",component:_,argTypes:{shape:{control:"select",options:["square","rounded","circle"]},size:{control:"select",options:["sm","md","lg"]},active:{control:"boolean"}}},b=["sm","md","lg"],A=["square","rounded","circle"],t={args:{shape:"square",size:"sm",active:!1}},i={args:{shape:"square",size:"sm",active:!0}},c={args:{shape:"square",size:"md",active:!1}},n={args:{shape:"square",size:"md",active:!0}},o={args:{shape:"square",size:"lg",active:!1}},l={args:{shape:"square",size:"lg",active:!0}},d={args:{shape:"rounded",size:"sm",active:!1}},u={args:{shape:"rounded",size:"sm",active:!0}},m={args:{shape:"rounded",size:"md",active:!1}},p={args:{shape:"rounded",size:"md",active:!0}},g={args:{shape:"rounded",size:"lg",active:!1}},v={args:{shape:"rounded",size:"lg",active:!0}},f={args:{shape:"circle",size:"sm",active:!1}},S={args:{shape:"circle",size:"sm",active:!0}},h={args:{shape:"circle",size:"md",active:!1}},y={args:{shape:"circle",size:"md",active:!0}},z={args:{shape:"circle",size:"lg",active:!1}},x={args:{shape:"circle",size:"lg",active:!0}},q={render:()=>s.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"5rem",margin:"2rem"},children:[s.jsx("div",{style:{display:"flex",gap:"5rem"},children:A.map(e=>s.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"2rem",alignItems:"flex-start"},children:b.map(a=>s.jsx(_,{shape:e,size:a,active:!1},`${e}-${a}-inactive`))},`inactive-${e}`))}),s.jsx("div",{style:{display:"flex",gap:"5rem"},children:A.map(e=>s.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"2rem",alignItems:"flex-start"},children:b.map(a=>s.jsx(_,{shape:e,size:a,active:!0},`${e}-${a}-active`))},`active-${e}`))})]})};var $,L,C;t.parameters={...t.parameters,docs:{...($=t.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    shape: 'square',
    size: 'sm',
    active: false
  }
} satisfies Story`,...(C=(L=t.parameters)==null?void 0:L.docs)==null?void 0:C.source}}};var R,M,j;i.parameters={...i.parameters,docs:{...(R=i.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    shape: 'square',
    size: 'sm',
    active: true
  }
} satisfies Story`,...(j=(M=i.parameters)==null?void 0:M.docs)==null?void 0:j.source}}};var D,I,O;c.parameters={...c.parameters,docs:{...(D=c.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    shape: 'square',
    size: 'md',
    active: false
...
} satisfies Story`,...(qe=(xe=z.parameters)==null?void 0:xe.docs)==null?void 0:qe.source}}};var _e,be,Ae;x.parameters={...x.parameters,docs:{...(_e=x.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  args: {
    shape: 'circle',
    size: 'lg',
    active: true
  }
} satisfies Story`,...(Ae=(be=x.parameters)==null?void 0:be.docs)==null?void 0:Ae.source}}};var $e,Le,Ce;q.parameters={...q.parameters,docs:{...($e=q.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
