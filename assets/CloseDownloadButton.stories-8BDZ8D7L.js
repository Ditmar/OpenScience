import{j as t}from"./jsx-runtime-DRTy3Uxn.js";import{I as v}from"./icons-DNNtq2Yd.js";import"./index-BBkUAzwr.js";import"./index-YMbfICiA.js";function u(w){const{icon:s,onClick:g,color:h}=w,f=`button__icon--${h}`;return t.jsx("button",{className:`close-download-button ${f}`,"aria-label":"Abrir",onClick:g,children:s&&t.jsx(v,{"data-testid":"button-icon",src:s,className:"button__icon"})})}u.__docgenInfo={description:"",methods:[],displayName:"CloseDownloadButton",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},icon:{required:!1,tsType:{name:"string"},description:""},color:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"}]},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const x=`<svg width="8" height="10" viewBox="0 0 8 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,_=`<svg width="80" height="85" viewBox="0 0 80 85" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,y=`<svg width="24" height="24" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,S={title:"ui/components/atoms/close-download-button",component:u,argTypes:{onClick:{action:"click"}}},o={args:{children:"close",icon:x}},e={args:{children:"close_simple",icon:y}},n={args:{children:"downloads",icon:_}};var r,a,i;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`{
  args: {
    children: 'close',
    icon: close
  }
}`,...(i=(a=o.parameters)==null?void 0:a.docs)==null?void 0:i.source}}};var c,l,d;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
...
}`,...(m=(p=n.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};const T=["CloseButton","CloseSimpleButton","DownloadButton"];export{o as CloseButton,e as CloseSimpleButton,n as DownloadButton,T as __namedExportsOrder,S as default};
