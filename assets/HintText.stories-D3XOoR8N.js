...
`;function C({text:g,size:f="medium",className:y=""}){const a=t[`hint-text--${f}`];return e.jsxs("div",{"data-testid":"hint-text",className:`${t["hint-text"]} ${a} ${y}`,children:[e.jsx(r,{"data-testid":"hint-icon-left",src:l,className:`${t["hint-text__icon"]} ${a}`}),e.jsx("span",{className:t["hint-text__text"],children:g}),e.jsx(r,{"data-testid":"hint-icon-right",src:l,className:`${t["hint-text__icon"]} ${t["hint-text__icon--right"]} ${a}`})]})}C.__docgenInfo={description:"",methods:[],displayName:"HintText",props:{text:{required:!0,tsType:{name:"string"},description:""},size:{required:!1,tsType:{name:"union",raw:"'small' | 'medium' | 'large'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"},{name:"literal",value:"'large'"}]},description:"",defaultValue:{value:"'medium'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"''",computed:!1}}}};const z={title:"ui/Components/Atoms/HintText",component:C,argTypes:{text:{control:"text"},size:{control:{type:"select"},options:["small","medium","large"]}}},i={args:{text:"Hint Text",size:"small"}},n={args:{text:"Hint Text",size:"medium"}},s={args:{text:"Hint Text",size:"large"}};var o,m,c;i.parameters={...i.parameters,docs:{...(o=i.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    text: 'Hint Text',
    size: 'small'
  }
}`,...(c=(m=i.parameters)==null?void 0:m.docs)==null?void 0:c.source}}};var x,d,_;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    text: 'Hint Text',
    size: 'medium'
  }
}`,...(_=(d=n.parameters)==null?void 0:d.docs)==null?void 0:_.source}}};var p,h,u;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    text: 'Hint Text',
    size: 'large'
  }
}`,...(u=(h=s.parameters)==null?void 0:h.docs)==null?void 0:u.source}}};const $=["Small","Medium","Large"];export{s as Large,n as Medium,i as Small,$ as __namedExportsOrder,z as default};
