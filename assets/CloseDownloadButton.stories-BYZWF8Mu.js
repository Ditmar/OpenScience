import{j as s}from"./jsx-runtime-_e34SzbC.js";import"./index-DVXBtNgz.js";function m(u){const{icon:w,onClick:g}=u;return s.jsx("button",{className:"close-download-button","aria-label":"Abrir",onClick:g,children:s.jsx("span",{className:"button__icon","data-testid":"button-icon",dangerouslySetInnerHTML:{__html:w??"<div></div>"}})})}m.__docgenInfo={description:"",methods:[],displayName:"CloseDownloadButton",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},icon:{required:!1,tsType:{name:"string"},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const h=`<svg width="8" height="10" viewBox="0 0 8 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,v=`<svg width="80" height="85" viewBox="0 0 80 85" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,f=`<svg width="24" height="24" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,B={title:"ui/components/atoms/close-download-button",component:m,argTypes:{onClick:{action:"click"}}},o={args:{children:"close",icon:h}},e={args:{children:"close_simple",icon:f}},n={args:{children:"downloads",icon:v}};var t,r,a;o.parameters={...o.parameters,docs:{...(t=o.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {
    children: 'close',
    icon: close
  }
}`,...(a=(r=o.parameters)==null?void 0:r.docs)==null?void 0:a.source}}};var i,c,l;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    children: 'close_simple',
    icon: close_simple
  }
}`,...(l=(c=e.parameters)==null?void 0:c.docs)==null?void 0:l.source}}};var C,d,p;n.parameters={...n.parameters,docs:{...(C=n.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    children: 'downloads',
    icon: downloads
  }
}`,...(p=(d=n.parameters)==null?void 0:d.docs)==null?void 0:p.source}}};const b=["CloseButton","CloseSimpleButton","DownloadButton"];export{o as CloseButton,e as CloseSimpleButton,n as DownloadButton,b as __namedExportsOrder,B as default};
