...
}`,...(x=(g=m.parameters)==null?void 0:g.docs)==null?void 0:x.source}}};var N,y,j;u.parameters={...u.parameters,docs:{...(N=u.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: args => {
    function WrapperComponent() {
      const [checked, setChecked] = useState(false);
      return <UserTextCard avatar={args.avatar} userName={args.userName} userHandle={args.userHandle} content={args.content} timestamp={args.timestamp} isVerified={args.isVerified} actions={args.actions} isChecked={checked} onClick={args.onClick} variant={args.variant} onCheckChange={newVal => {
...
}`,...(j=(y=u.parameters)==null?void 0:y.docs)==null?void 0:j.source}}};const P=["Normal","Compact","Expanded"];export{m as Compact,u as Expanded,d as Normal,P as __namedExportsOrder,O as default};
