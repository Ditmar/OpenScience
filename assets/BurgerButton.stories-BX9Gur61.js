import{j as i}from"./jsx-runtime-BlDnFLNC.js";import{I as g}from"./icons-Dqqr9IZ9.js";import"./index-Cu9bd8lq.js";import"./index-gagdKHFB.js";const h="_secondary_11835_17",r={"button-burger":"_button-burger_11835_1",secondary:h,"button-icon":"_button-icon_11835_49"};function u({icon:t,color:a,onClick:m}){const C=a?r[a]:"";return i.jsx("button",{className:`${r["button-burger"]} ${C}`,"aria-label":"Menu",onClick:m,children:t&&i.jsx(g,{"data-testid":"button-icon",src:t,className:r["button-icon"]})})}u.__docgenInfo={description:"",methods:[],displayName:"BurgerButton",props:{variant:{required:!1,tsType:{name:"union",raw:"'main' | 'secondary'",elements:[{name:"literal",value:"'main'"},{name:"literal",value:"'secondary'"}]},description:""},icon:{required:!1,tsType:{name:"string"},description:""},color:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"}]},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const f=`<svg width="62" height="62" viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,H={title:"ui/components/atoms/burger-bsutton",component:u,argTypes:{onClick:{action:"clicked"}}},n={args:{icon:f,variant:"main",color:"primary",onClick:()=>{}}},e={args:{variant:"secondary",icon:w,onClick:()=>{}}};var o,s,c;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    icon: IconBurger,
    variant: 'main',
    color: 'primary',
...
}`,...(c=(s=n.parameters)==null?void 0:s.docs)==null?void 0:c.source}}};var l,p,d;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    variant: 'secondary',
    icon: Burger,
    onClick: () => {}
  }
}`,...(d=(p=e.parameters)==null?void 0:p.docs)==null?void 0:d.source}}};const B=["Primary","Secondary"];export{n as Primary,e as Secondary,B as __namedExportsOrder,H as default};
