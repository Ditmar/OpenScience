import{j as i}from"./jsx-runtime-DRTy3Uxn.js";import{I as C}from"./icons-DNNtq2Yd.js";import"./index-BBkUAzwr.js";import"./index-YMbfICiA.js";const h="_secondary_11qa2_17",t={"button-burger":"_button-burger_11qa2_1",secondary:h,"button-icon":"_button-icon_11qa2_49"};function u({icon:r,color:o,onClick:m}){const g=o?t[o]:"";return i.jsx("button",{className:`${t["button-burger"]} ${g}`,"aria-label":"Menu",onClick:m,children:r&&i.jsx(C,{"data-testid":"button-icon",src:r,className:t["button-icon"]})})}u.__docgenInfo={description:"",methods:[],displayName:"BurgerButton",props:{variant:{required:!1,tsType:{name:"union",raw:"'main' | 'secondary'",elements:[{name:"literal",value:"'main'"},{name:"literal",value:"'secondary'"}]},description:""},icon:{required:!1,tsType:{name:"string"},description:""},color:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"}]},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const f=`<svg width="62" height="62" viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg">
