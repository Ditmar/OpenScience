import{j as t}from"./jsx-runtime-BTJTZTIL.js";import{r as v}from"./index-CJ_LmFaV.js";import{I as j}from"./icons-CVVufTdu.js";import"./index-ChsGqxH_.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./index-CQJd15Kt.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";const I="_login__field_1tm7n_1",M="_invalid__input_1tm7n_24",Z="_password__eye_1tm7n_27",S="_eye__icon_1tm7n_43",s={login__field:I,invalid__input:M,password__eye:Z,eye__icon:S},B=n=>{const[e,r]=v.useState(n);return{form:e,handlerChangeForm:({target:a})=>{r({...e,[a.name]:a.value})},handlerResetForm:()=>{r(n)}}};function x({label:n,type:e,name:r,placeholder:p,isValid:d,eyeIcon:a,onChangeValue:F}){const[m,b]=v.useState(e),{form:E,handlerChangeForm:T}=B({value:""});function q(N){T(N),F(E)}function V(){b(m==="password"?"text":"password")}return t.jsxs("div",{className:s.login__field,children:[t.jsx("span",{children:n}),t.jsx("input",{type:m,name:r,placeholder:p,onChange:q,className:d?"":s.invalid__input}),e==="password"&&t.jsx("button",{type:"button",className:s.password__eye,onClick:V,children:a&&t.jsx(j,{"data-testid":"eye-icon",src:a,className:s.eye__icon})})]})}x.__docgenInfo={description:"",methods:[],displayName:"InputText",props:{id:{required:!0,tsType:{name:"string"},description:""},label:{required:!0,tsType:{name:"string"},description:""},type:{required:!0,tsType:{name:"union",raw:"'email' | 'password' | 'text'",elements:[{name:"literal",value:"'email'"},{name:"literal",value:"'password'"},{name:"literal",value:"'text'"}]},description:""},name:{required:!0,tsType:{name:"string"},description:""},placeholder:{required:!1,tsType:{name:"string"},description:""},value:{required:!0,tsType:{name:"string"},description:""},isValid:{required:!0,tsType:{name:"boolean"},description:""},eyeIcon:{required:!1,tsType:{name:"string"},description:""},onChangeValue:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: { value: string }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ value: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}}]}},name:"value"}],return:{name:"void"}}},description:""}}};const P=`<svg width="51" height="27" viewBox="0 0 51 27" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,z={title:"ui/components/atoms/input-text",component:x,argTypes:{isValid:{control:"boolean"}}},i={args:{label:"Email",type:"email",name:"email",placeholder:"",isValid:!0}},o={args:{label:"Contraseña",type:"password",name:"password",placeholder:"",isValid:!0,eyeIcon:P}},l={args:{label:"Nombre",type:"text",name:"name",placeholder:"",isValid:!0}};var c,u,_;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    label: 'Email',
    type: 'email',
    name: 'email',
...
}`,...(f=(w=l.parameters)==null?void 0:w.docs)==null?void 0:f.source}}};const G=["EmptyEmailField","EmptyPasswordField","EmptyNameField"];export{i as EmptyEmailField,l as EmptyNameField,o as EmptyPasswordField,G as __namedExportsOrder,z as default};
