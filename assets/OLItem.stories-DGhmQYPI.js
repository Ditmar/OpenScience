import{j as s}from"./jsx-runtime-DRTy3Uxn.js";import"./index-BBkUAzwr.js";const r={"ol-item":"_ol-item_1gscj_73","ol-item--square":"_ol-item--square_1gscj_85","ol-item--rounded":"_ol-item--rounded_1gscj_88","ol-item--circle":"_ol-item--circle_1gscj_91","ol-item--sm":"_ol-item--sm_1gscj_94","ol-item--md":"_ol-item--md_1gscj_99","ol-item--lg":"_ol-item--lg_1gscj_104","ol-item--active":"_ol-item--active_1gscj_109"};function _({value:e,shape:a="square",size:Re="md",active:Me=!1}){const Ie=`
    ${r["ol-item"]}
    ${r[`ol-item--${a}`]}
    ${r[`ol-item--${Re}`]}
    ${Me?r["ol-item--active"]:""}
  `.trim();return s.jsx("div",{className:Ie,role:"listitem",children:e})}_.__docgenInfo={description:"",methods:[],displayName:"OLItem",props:{value:{required:!0,tsType:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}]},description:""},shape:{required:!1,tsType:{name:"union",raw:"'square' | 'rounded' | 'circle'",elements:[{name:"literal",value:"'square'"},{name:"literal",value:"'rounded'"},{name:"literal",value:"'circle'"}]},description:"",defaultValue:{value:"'square'",computed:!1}},size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'md'",computed:!1}},active:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const Te={title:"ui/components/atoms/ol-item",component:_,argTypes:{shape:{control:"select",options:["square","rounded","circle"]},size:{control:"select",options:["sm","md","lg"]},active:{control:"boolean"},value:{control:"text"}}},A=["sm","md","lg"],j=["square","rounded","circle"],t={args:{value:"1",shape:"square",size:"sm",active:!1}},i={args:{value:"1",shape:"square",size:"sm",active:!0}},n={args:{value:"1",shape:"square",size:"md",active:!1}},c={args:{value:"1",shape:"square",size:"md",active:!0}},o={args:{value:"1",shape:"square",size:"lg",active:!1}},l={args:{value:"1",shape:"square",size:"lg",active:!0}},u={args:{value:"1",shape:"rounded",size:"sm",active:!1}},m={args:{value:"1",shape:"rounded",size:"sm",active:!0}},d={args:{value:"1",shape:"rounded",size:"md",active:!1}},p={args:{value:"1",shape:"rounded",size:"md",active:!0}},v={args:{value:"1",shape:"rounded",size:"lg",active:!1}},g={args:{value:"1",shape:"rounded",size:"lg",active:!0}},f={args:{value:"1",shape:"circle",size:"sm",active:!1}},S={args:{value:"1",shape:"circle",size:"sm",active:!0}},h={args:{value:"1",shape:"circle",size:"md",active:!1}},y={args:{value:"1",shape:"circle",size:"md",active:!0}},z={args:{value:"1",shape:"circle",size:"lg",active:!1}},q={args:{value:"1",shape:"circle",size:"lg",active:!0}},x={render:()=>s.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"5rem",margin:"2rem"},children:[s.jsx("div",{style:{display:"flex",gap:"3.5rem"},children:j.map(e=>s.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"3rem",alignItems:"flex-start"},children:A.map(a=>s.jsx(_,{value:"1",shape:e,size:a,active:!1},`${e}-${a}-inactive`))},`inactive-${e}`))}),s.jsx("div",{style:{display:"flex",gap:"3rem"},children:j.map(e=>s.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"3rem",alignItems:"flex-start"},children:A.map(a=>s.jsx(_,{value:"1",shape:e,size:a,active:!0},`${e}-${a}-active`))},`active-${e}`))})]})};var $,L,C;t.parameters={...t.parameters,docs:{...($=t.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    value: '1',
    shape: 'square',
    size: 'sm',
...
} satisfies Story`,...(C=(L=t.parameters)==null?void 0:L.docs)==null?void 0:C.source}}};var R,M,I;i.parameters={...i.parameters,docs:{...(R=i.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    value: '1',
    shape: 'square',
    size: 'sm',
...
} satisfies Story`,...(I=(M=i.parameters)==null?void 0:M.docs)==null?void 0:I.source}}};var D,O,T;n.parameters={...n.parameters,docs:{...(D=n.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    value: '1',
    shape: 'square',
    size: 'md',
...
} satisfies Story`,...(se=(ee=p.parameters)==null?void 0:ee.docs)==null?void 0:se.source}}};var ae,re,te;v.parameters={...v.parameters,docs:{...(ae=v.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  args: {
    value: '1',
    shape: 'rounded',
    size: 'lg',
...
} satisfies Story`,...(te=(re=v.parameters)==null?void 0:re.docs)==null?void 0:te.source}}};var ie,ne,ce;g.parameters={...g.parameters,docs:{...(ie=g.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  args: {
    value: '1',
    shape: 'rounded',
    size: 'lg',
