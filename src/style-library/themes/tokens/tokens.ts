...
const tokens: DesignTokens = {
  ...
  "colors": {
    ...
    "main": "#fff",
    "size_main": "1.3rem",
    "text_main-alpha": "rgb(2 50 44 / 85%)",
    "font_weight-bold": "700",
    "letter_spacing": "0.0625rem",
    "font_weight": "700",
    "font_size-primary": "1rem",
    "font_size-first": "6rem",
    "font_size-third": "8rem",
    "font_size-second": "1.75rem",
    "font_size-quarter": "2.5rem",
    "font_size-fifth": "0.75rem",
    "font_size-sixth": "0.938rem",
    "font_weight-first": "400",
    "font_weight-second": "800",
    "line_height-default": "1.3",
    "padding_large": "2rem",
    "background_desktop": "rgb(217 217 217 / 40%)",
    "background_color-black": "rgb(0 0 0 / 30%)",
    "text_input": "#a6a6a6"
  },
  "typography": {
    "fonts": {
