...
export default meta;
type Story = StoryObj<IconImageProps>;

export const AllVariants: Story = {
  render: () => {
    const sizes: NonNullable<IconImageProps['size']>[] = ['small', 'medium', 'large'];
    const colors: NonNullable<IconImageProps['color']>[] = [
      'inherit',
      'primary',
      'secondary',
      'action',
    ...
    const variants: NonNullable<IconImageProps['variant']>[] = [
      'filled',
      'outlined',
      'rounded',
      'twoTone',
