...
export const Default: StoryObj<typeof CountryListDropdown> = {
  args: {
...
export const SpainSelected: StoryObj<typeof CountryListDropdown> = {
  args: {
    countries: mockCountries,
    selectedCountry: 'ES',
    isOpen: true,
...
export const UnitedStatesSelected: StoryObj<typeof CountryListDropdown> = {
  args: {
    countries: mockCountries,
    selectedCountry: 'US',
    isOpen: true,
...
export const LargeSize: StoryObj<typeof CountryListDropdown> = {
  args: {
    countries: mockCountries,
    selectedCountry: '',
    isOpen: true,
...
export const WithInputIntegration: StoryObj<typeof CountryListDropdown> = {
  render: ({ countries, selectedCountry, isOpen, onSelectCountry, onClose }) => (
    <div>
      <input
        type="text"
