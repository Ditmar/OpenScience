...
describe('LogoGoogleFacebook Component', () => {
  test('should render logo and buttons', () => {
    render(<LogoGoogleFacebook googleIcon={GoogleIcon} facebookIcon={FacebookIcon} logoIcon={LogoIcon} />);
  ...
  test('should handle Google login click', () => {
    ...
    render(<LogoGoogleFacebook googleIcon={GoogleIcon} facebookIcon={FacebookIcon} logoIcon={LogoIcon} onGoogleLogin={handleGoogleLogin} />);
    const googleButton = screen.getByText(/Google/i);
  ...
  test('should handle Facebook login click', () => {
    ...
    render(<LogoGoogleFacebook googleIcon={GoogleIcon} facebookIcon={FacebookIcon} logoIcon={LogoIcon} onFacebookLogin={handleFacebookLogin} />);
    const facebookButton = screen.getByText(/Facebook/i);
