import{j as i}from"./jsx-runtime-BlDnFLNC.js";import{C as S,a as e}from"./countryMock-CPdtN4Ag.js";import"./index-Cu9bd8lq.js";import"./Box-CHmXPhC_.js";import"./DefaultPropsProvider--zJBLwLZ.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm-B34fLoo2.js";import"./memoTheme-BE2zh0Q8.js";import"./extends-CF3RwP-h.js";import"./index-RT4BIXZQ.js";import"./Avatar-CNQMpQjD.js";import"./createSvgIcon-BkY5K6L4.js";import"./useSlot-CMLYqNBn.js";import"./useForkRef-CXZ2Yisc.js";import"./Typography--HJDdM_o.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";const O={title:"ui/Components/Atoms/IconFlag",component:S,parameters:{docs:{page:null}},argTypes:{size:{options:["small","medium","large"],control:{type:"radio"},description:"Tamaño del texto"},variant:{options:["circular","rectangular"],control:{type:"radio"},description:"Forma de la bandera",defaultValue:"circular"}}},a={args:{...e.find(r=>r.code==="AR"),size:"medium",variant:"circular"}},o={args:{...e.find(r=>r.code==="AR"),variant:"rectangular"}},t={args:{...e.find(r=>r.code==="AR"),size:"small"}},n={args:{...e.find(r=>r.code==="AR"),size:"large"}},s={render:()=>i.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(250px, 1fr))",gap:"16px",width:"100%"},children:e.map(r=>i.jsx(S,{src:r.src,alt:r.alt,name:r.name,dialCode:r.dialCode,code:r.code},r.code))}),parameters:{controls:{hideNoControlsWarning:!0},viewport:{defaultViewport:"desktop"}}};var c,l,d;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
