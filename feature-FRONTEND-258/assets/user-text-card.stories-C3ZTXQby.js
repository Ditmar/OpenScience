...
}`,...(b=(w=l.parameters)==null?void 0:w.docs)==null?void 0:b.source}}};var H,y,U;p.parameters={...p.parameters,docs:{...(H=p.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: args => {
    function WrapperComponent() {
      const [checked, setChecked] = useState(false);
      return <UserTextCard avatar={args.avatar} userName={args.userName} userHandle={args.userHandle} content={args.content} timestamp={args.timestamp} isVerified={args.isVerified} actions={args.actions} isChecked={checked} onClick={args.onClick} variant={args.variant} colorVariant={args.colorVariant} onCheckChange={newVal => {
...
}`,...(U=(y=p.parameters)==null?void 0:y.docs)==null?void 0:U.source}}};var j,T,S;h.parameters={...h.parameters,docs:{...(j=h.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: args => {
    function WrapperComponent() {
      const [checked, setChecked] = useState(false);
      return <UserTextCard avatar={args.avatar} userName={args.userName} userHandle={args.userHandle} content={args.content} timestamp={args.timestamp} isVerified={args.isVerified} actions={args.actions} isChecked={checked} onClick={args.onClick} variant={args.variant} colorVariant={args.colorVariant} onCheckChange={newVal => {
...
}`,...(X=(L=k.parameters)==null?void 0:L.docs)==null?void 0:X.source}}};var E,R,A;v.parameters={...v.parameters,docs:{...(E=v.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: args => {
    function WrapperComponent() {
      const [checked, setChecked] = useState(false);
      return <UserTextCard avatar={args.avatar} userName={args.userName} userHandle={args.userHandle} content={args.content} timestamp={args.timestamp} isVerified={args.isVerified} actions={args.actions} isChecked={checked} onClick={args.onClick} variant={args.variant} colorVariant={args.colorVariant} onCheckChange={newVal => {
...
}`,...(A=(R=v.parameters)==null?void 0:R.docs)==null?void 0:A.source}}};const we=["Normal","Compact","Expanded","Info","Warning","Success","Error"];export{l as Compact,v as Error,p as Expanded,h as Info,u as Normal,k as Success,C as Warning,we as __namedExportsOrder,Ne as default};
